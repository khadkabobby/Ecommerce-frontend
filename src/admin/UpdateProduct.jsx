...
const UpdateProduct = () => {
  ...
  const getSingleCategory = async () => {
    try {
      ...
      if (data?.success) {
        toast.success("successful is best thing in the world");
  ...
  const handleDeleteButton = async () => {
    try {
      let answer = window.prompt(
        "Are you sure want to delete product Type yes for sure"
      );
      if (answer !== "yes") {
        return;
      }
      ...
      <div className="container-fluid m-3 p-3">
        <div className="row">
          ...
          <div className="col-md-9 mt-2">
            ...
            <div className="m-1 w-75">
              ...
              <div className="mb-3">
                {photo ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`data:${data?.product?.photo?.contentType};base64,${data?.product?.photo?.data}`}
                      alt="product photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
            ...
            <div className="mb-3 text-center w-75 d-flex justify-content-between">
              <button className="btn btn-primary" onClick={handleUpdateButton}>
                UPDATE PRODUCT
              </button>
